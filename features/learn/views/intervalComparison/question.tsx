      ...
      <View className="mt-[8px] flex-1">
        ...
        <View className="mx-[20px] mt-[40%] flex-1 flex-row gap-[10px]">
          <LearnExerciseQuestionButton
            ...
            correct={
              currentAnswer &&
              ((currentAnswer?.index === 0 && currentAnswer.isCorrect) ||
                currentQuestion.correctIndex === 0)
            }
            incorrect={currentAnswer && currentAnswer?.index === 0 && !currentAnswer.isCorrect}
            buttonClassName={
          ...
          <LearnExerciseQuestionButton
            ...
            correct={
              currentAnswer &&
              ((currentAnswer?.index === 1 && currentAnswer.isCorrect) ||
        ...
        <LearnExerciseFooter
          ...
          label={currentAnswer ? t('exercise.continue') : t('exercise.check')}
        ...
        {currentAnswer && (
          <LearnExerciseFooterAnswer
            ...
            messageData={
              (currentAnswer?.isCorrect ? correctMessageData : incorrectMessageData) as any
            }
          />
        )}
      </View>
